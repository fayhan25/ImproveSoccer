  ...
  return (
    <div className={styles.container}>
      <header className="bg-dark text-white text-center py-5">
        ...
        <p className="lead">Your ultimate soccer improvement app</p>
      </header>
      ...
      <div className="my-3">
        <Carousel>
          ...
          <Carousel.Item>
            <div className={styles.carouselImageContainer}>
              <Image src="/images/soccer4.jpg" alt="Team" layout="fill" objectFit="cover" />
            </div>
            <Carousel.Caption>
              <h3>Track Your Progress</h3>
              <p style={{fontWeight:'bold'}}>You can track your progress as you improve and use this app as your soccer diary</p>
            </Carousel.Caption>
          </Carousel.Item>
        </Carousel>
      </div>
